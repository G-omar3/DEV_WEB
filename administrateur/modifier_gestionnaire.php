...
if (isset($_GET['id'])) {
    ...
    $stmt = $pdo->prepare("SELECT * FROM users WHERE id = ? AND role = 'Gestionnaire'");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("UPDATE users SET `name` = ?, prenom = ?, email = ?, `password` = ? WHERE id = ? AND role = 'Gestionnaire'");
            ...
            <div class="card-body">
                <form method="POST" action="modifier_gestionnaire.php?id=<?= $gestionnaire_id ?>">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom" value="<?= htmlspecialchars($gestionnaire['name']) ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" id="mot_de_passe" name="mot_de_passe" value="<?= htmlspecialchars($gestionnaire['password']) ?>" required>

...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['confirm_delete'])) {
    $stmt = $pdo->prepare("DELETE FROM users WHERE id = ? AND role = 'Gestionnaire'");
...
$stmt = $pdo->prepare("SELECT `name`, prenom FROM users WHERE id = ? AND role = 'Gestionnaire'");
$stmt->execute([$gestionnaire_id]);
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p><strong><?= htmlspecialchars($gestionnaire['name'] . ' ' . $gestionnaire['prenom']) ?></strong></p>

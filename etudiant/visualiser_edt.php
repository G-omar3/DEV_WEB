...
$stmt = $pdo->prepare("
    SELECT Cours.*, Module.nom AS module_nom, users.name AS enseignant_nom, users.prenom AS enseignant_prenom, Salle.nom AS salle_nom, EmploiDuTemps.date_heure, EmploiDuTemps.heure_debut, EmploiDuTemps.heure_fin
    FROM EmploiDuTemps
